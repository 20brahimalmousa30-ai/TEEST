...
export const invoices: Invoice[] = [
  ...
  { id: "inv004", code: "INV-1448-004", vendor: "متجر النَّجم للهدايا",       purpose: "هدايا أسرة المرتفعات",           scope: { kind: "team", teamId: "t1" },           amount:  3600, vat: 15, date: "1448-07-22", status: "paid",    extractedByAI: true  },
