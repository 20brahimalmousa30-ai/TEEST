...
export const activity: Activity[] = [
  ...
  { id: "a2",  time: "قبل ٢٢ دقيقة",  actor: "المشرف: نورة الغامدي",    action: "سجّلت حضور",           target: "٤١ طالبةً من أسرة رَواسي",          kind: "add"  },
  { id: "a3",  time: "قبل ساعة",       actor: "الأمير الأصل",           action: "اعتمد سداداً",         target: "أسرة المرتفعات — دفعة نهائيّة",     kind: "pay"  },
  { id: "a4",  time: "قبل ساعتين",    actor: "المشرف: أحمد الشهري",     action: "أضاف طلاباً",         target: "٣ طلابٍ إلى أسرة المرتفعات",         kind: "add"  },
  { id: "a5",  time: "قبل ٣ ساعات",   actor: "نائب الأمير",            action: "عدّل حقلاً في نموذج التسجيل", target: "حقل «الحالة الصحيّة»",         kind: "edit" },
  { id: "a6",  time: "قبل ٤ ساعات",   actor: "المشرف: خالد آل مساعد",   action: "أرسل رسالة واتساب",   target: "لأولياء أمور أسرة السَّرَاة",         kind: "note" },
