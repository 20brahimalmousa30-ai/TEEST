...
export const teams: Team[] = [
  { id: "t1",  name: "المرتفعات",     badge: "M", color: "#1E4635", supervisorId: "s1",  studentCount: 40, points: 385, tagline: "أعلى أسرةٍ بفارقٍ مريح — ثباتٌ لأربعة أيّامٍ متتالية." },
  ...
  { id: "t4",  name: "رَواسي",        badge: "R", color: "#4E6B7A", supervisorId: "s4",  studentCount: 41, points: 298, tagline: "الأسرة النسائيّة — أعلى نسبة حضور." },
  ...
  { id: "t9",  name: "الأودية",      badge: "AW", color: "#2E5A5A", supervisorId: "s9",  studentCount: 36, points: 231, tagline: "الأسرة الفتيّة — أصغر أعضاء الرحلة." },
